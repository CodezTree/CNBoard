...
public class LakeViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MealList.add(new Meal("2019년 03월 06일", "수요일 중식 메뉴", 1));
        MealList.add(new Meal("2019년 03월 06일", "수요일 석식 메뉴", 2));
        MealList.add(new Meal("2019년 03월 07일", "목요일 조식 메뉴", 0));
        MealList.add(new Meal("2019년 03월 07일", "목요일 중식 메뉴", 1));
        MealList.add(new Meal("2019년 03월 07일", "목요일 석식 메뉴", 2));
        MealList.add(new Meal("2019년 03월 08일", "금요일 조식 메뉴", 0));
        MealList.add(new Meal("2019년 03월 08일", "금요일 중식 메뉴", 1));
        MealList.add(new Meal("2019년 03월 08일", "금요일 석식 메뉴", 2));
        MealList.add(new Meal("2019년 03월 09일", "토요일 조식 메뉴", 0));
        MealList.add(new Meal("2019년 03월 09일", "토요일 중식 메뉴", 1));
        MealList.add(new Meal("2019년 03월 09일", "토요일 석식 메뉴", 2));
        MealList.add(new Meal("2019년 03월 10일", "일요일 조식 메뉴", 0));
        MealList.add(new Meal("2019년 03월 10일", "일요일 중식 메뉴", 1));
        MealList.add(new Meal("2019년 03월 10일", "일요일 석식 메뉴", 2));
        ...
        txt_mon2.setText(MealList.get(1).meal_txt);
        ...
        txt_mon3.setText(MealList.get(2).meal_txt);
        ...
        txt_tue1.setText(MealList.get(3).meal_txt);
        ...
        txt_tue2.setText(MealList.get(4).meal_txt);
        ...
        txt_tue3.setText(MealList.get(5).meal_txt);
        ...
        txt_wed1.setText(MealList.get(6).meal_txt);
        ...
        txt_wed2.setText(MealList.get(7).meal_txt);
        ...
        txt_wed3.setText(MealList.get(8).meal_txt);
        ...
        txt_thu1.setText(MealList.get(9).meal_txt);
        ...
        txt_thu3.setText(MealList.get(11).meal_txt);
        ...
        txt_fri1.setText(MealList.get(12).meal_txt);
        ...
        txt_fri2.setText(MealList.get(13).meal_txt);
        ...
        txt_fri3.setText(MealList.get(14).meal_txt);
        ...
        txt_sat1.setText(MealList.get(15).meal_txt);
        ...
        txt_sat2.setText(MealList.get(16).meal_txt);
        ...
        txt_sat3.setText(MealList.get(17).meal_txt);
        ...
        txt_sun1.setText(MealList.get(18).meal_txt);
        ...
        txt_sun2.setText(MealList.get(19).meal_txt);
